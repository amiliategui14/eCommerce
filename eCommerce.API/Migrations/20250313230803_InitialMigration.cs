    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Departartamentos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "DepartartamentoUsuario",
                columns: table => new
                {
                    DepartartamentosId = table.Column<int>(type: "int", nullable: false),
                    UsuariosId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartartamentoUsuario", x => new { x.DepartartamentosId, x.UsuariosId });
                    table.ForeignKey(
                        name: "FK_DepartartamentoUsuario_Departartamentos_DepartartamentosId",
                        column: x => x.DepartartamentosId,
                        principalTable: "Departartamentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DepartartamentoUsuario_Usuarios_UsuariosId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepartartamentoUsuario_UsuariosId",
                table: "DepartartamentoUsuario",
                column: "UsuariosId");

...
namespace eCommerce.API.Migrations
{
    ...
    [Migration("20250313230803_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DepartartamentoUsuario", b =>
                {
                    b.Property<int>("DepartartamentosId")
                        .HasColumnType("int");

                    b.Property<int>("UsuariosId")
                        .HasColumnType("int");

                    b.HasKey("DepartartamentosId", "UsuariosId");

                    b.HasIndex("UsuariosId");

                    b.ToTable("DepartartamentoUsuario");
                });
            ...
            modelBuilder.Entity("eCommerce.Models.Departartamento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DepartartamentoUsuario", b =>
                {
                    b.HasOne("eCommerce.Models.Departartamento", null)
                        .WithMany()
                        .HasForeignKey("DepartartamentosId")
